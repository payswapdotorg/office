...
// OFF-034 LOCAL vitest config — a standalone single-package runner.
//
...
//
//   pnpm exec vitest run -c packages/intelligence/procurement/vitest.config.ts
...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@office/domain-cost': here('../../domain/cost/src/index.ts'),
