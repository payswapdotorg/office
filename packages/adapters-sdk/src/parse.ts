// Office adapters-sdk — package-internal parse plumbing (OFF-020).
//
// Total, fail-closed parse combinators for the adapters-sdk package's own
...
// Office boundary uses). Mirrors the internal helper layers of the contracts
// and authz packages: those helpers are deliberately package-internal THERE,
// so this module repeats the small combinator set for the adapters SDK.
//
