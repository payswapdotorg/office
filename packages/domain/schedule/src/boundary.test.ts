...
// OFF-010 schedule domain — package boundary self-gate. These checks mirror
// the work item's acceptance boundary: @office/domain-schedule declares
// exactly five runtime dependencies (@office/contracts, @office/domain-kernel,
...
// below). No domain-to-domain imports: the schedule package consumes shared
...
const ownPackageName = ['@office', '/domain-schedule'].join('');
...
// this package — the schedule contract is Office-canonical; provider import
// happens in adapter packages owned elsewhere).
...
describe('schedule domain package boundary (OFF-010)', () => {
  it('carries the canonical schedule package identity (0.1.0, private, ESM)', () => {
