// Office organization domain — package-internal parse helpers (OFF-007).
//
...
// received-value descriptions). NOT exported from the package root: only the
// command modules of this package use these helpers; payload shapes are the
