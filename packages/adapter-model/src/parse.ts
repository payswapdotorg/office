// Office adapter-model — package-internal parse plumbing (OFF-022).
//
...
// boundary uses). Mirrors the internal helper layer of packages/adapters-sdk
// (OFF-020): those helpers are deliberately package-internal THERE, so this
// module repeats the small combinator set for the model adapter.
//
...
/** Require a positive finite number field (quantities, counts). */
