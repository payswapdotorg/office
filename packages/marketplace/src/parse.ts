// Office marketplace — package-internal parse plumbing (OFF-027).
//
// Total, fail-closed parse combinators for the marketplace package's own
...
// contracts, authz, app-sdk, and app-runtime packages: those helpers are
// deliberately package-internal THERE, so this module repeats the small
// combinator set for the marketplace.
//
 ...
 * nested element failure reads `apps[0]`, never `apps.[0]`.
 */
 ...
 * OWN internal path when it has one.
 */
