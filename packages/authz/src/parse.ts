// Office authz — package-internal parse plumbing (OFF-006).
//
// Total, fail-closed parse combinators for the authz package's own value
...
// boundary uses). Mirrors the contracts package's internal helper layer:
// those helpers are deliberately package-internal THERE, so this module
// repeats the small combinator set for authz.
//
